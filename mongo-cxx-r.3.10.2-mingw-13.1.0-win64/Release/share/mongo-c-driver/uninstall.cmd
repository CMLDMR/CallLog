...
if "%DESTDIR%"=="" (
  set __prefix=C:\mongocxx\mongo-cxx-mingw-13.1.0-install
) else (
  set __prefix=!DESTDIR!\mongocxx\mongo-cxx-mingw-13.1.0-install
)

call :rmfile "lib\libbson-static-1.0.a"
...
call :rmfile "lib\libbson-1.0.dll.a"
call :rmfile "bin\libbson-1.0.dll"
...
call :rmfile "lib\libmongoc-static-1.0.a"
call :rmfile "lib\libmongoc-1.0.dll.a"
call :rmfile "bin\libmongoc-1.0.dll"
